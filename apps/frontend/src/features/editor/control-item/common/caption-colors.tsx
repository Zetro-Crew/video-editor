...
const CaptionColors = ({
	...
	}, [appearedColor, activeColor, activeFillColor, isKeywordColor, preservedColorKeyWord]);
	...
	return (
		<div className="flex flex-col gap-2 py-4">
			...
			<div className="flex gap-2">
				<div className="flex flex-1 items-center text-sm text-muted-foreground">Appeared</div>
				{isLargeScreen ? (
					...
					<div className="relative w-32">
						<div className="relative cursor-pointer" onClick={handleAppearedColorClick}>
							<div
								style={{
									backgroundColor: localAppearedColor,
								}}
			...
			<div className="flex gap-2">
				<div className="flex flex-1 items-center text-sm text-muted-foreground">Active</div>
				{isLargeScreen ? (
					<div className="relative w-32">
						<Popover>
							<PopoverTrigger asChild>
					...
					<div className="relative w-32">
						<div className="relative cursor-pointer" onClick={handleActiveColorClick}>
							<div
								style={{
									backgroundColor: localActiveColor,
								}}
			...
			<div className="flex gap-2">
				<div className="flex flex-1 items-center text-sm text-muted-foreground">Active Fill</div>
				{isLargeScreen ? (
					<div className="relative w-32">
						<Popover>
							<PopoverTrigger asChild>
					...
					<div className="relative w-32">
						<div className="relative cursor-pointer" onClick={handleActiveFillColorClick}>
							<div
								style={{
									backgroundColor: localActiveFillColor,
								}}
			...
			<div className="flex gap-2">
				<div className="flex flex-1 items-center text-sm text-muted-foreground">Emphasize</div>
				{isLargeScreen ? (
					<div className="relative w-32">
						<Popover>
							<PopoverTrigger asChild>
					...
					<div className="relative w-32">
						<div className="relative cursor-pointer" onClick={handleEmphasizeColorClick}>
							<div
								style={{
									backgroundColor: localEmphasizeColor,
								}}
