				...
				>
					<DialogOverlay className="z-[300] bg-zinc-950/80">
						<DialogContent
							...
							className="z-[300] flex max-h-[800px] w-full sm:max-w-[900px] flex-col bg-zinc-950 px-8"
						>
							...
							<div className="flex gap-4">
								<div className="w-56 flex flex-col gap-2">
									...
									<Select value={aspectRatio} onValueChange={setAspectRatio} defaultValue="free">
