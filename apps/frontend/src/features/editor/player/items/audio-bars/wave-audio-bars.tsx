...
export const WaveBars = ({
	...
	return (
		<WaveVisualization
			...
			{...(details.topRoundness != null ? { topRoundness: details.topRoundness } : {})}
			{...(details.bottomRoundness != null ? { bottomRoundness: details.bottomRoundness } : {})}
			{...(details.lines != null && details.lines !== 0 ? { lines: details.lines } : {})}
