...
export const ScalePulseAnimationCaption = (frame: number, to: number, fps: number) => {
...
export const ScaleAnimationLoop = (frame: number, phase1Duration = 15, phase2Duration = 15) => {
	const totalDuration = phase1Duration + phase2Duration;
	const cycleFrame = frame % totalDuration;
