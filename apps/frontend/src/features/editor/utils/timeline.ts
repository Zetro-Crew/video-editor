...
const getPreviousZoom = (currentZoom: ITimelineScaleState): ITimelineScaleState | null => {
...
const getNextZoom = (currentZoom: ITimelineScaleState): ITimelineScaleState | null => {
...
function calculateTimelineWidth(totalLengthMs: number, zoom = 1): number {
	return timeMsToUnits(totalLengthMs, zoom);
}
